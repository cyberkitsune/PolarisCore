...
namespace Polaris.Lib.Data
{
    ...
    public class QuestAvailable
    {
        public short[] Amount { get; set; } = new short[Enum.GetValues(typeof(QuestType)).Length];
        public QuestTypeAvailable Available { get; set; } = QuestTypeAvailable.Arks;
    }
}
